...
public class MvpdLogoutActivity extends AbstractActivity {
    ...
    public void onCreate(Bundle savedInstanceState)
    {
        ...
        WebView logoutWebView = (WebView) findViewById(R.id.mvpd_login_webview);

        // install listeners for various page load events
        logoutWebView.setWebViewClient(webViewClient);

        // enable JavaScript support
        WebSettings browserSettings = logoutWebView.getSettings();
    ...
    private final WebViewClient webViewClient = new WebViewClient() {
        public boolean shouldOverrideUrlLoading(WebView view, String url){
            ...
            if (url.startsWith(AccessEnablerConstants.ADOBEPASS_REDIRECT_URL_SCHEME)) {
                ...
                Intent result = new Intent(MvpdLogoutActivity.this, MainActivity.class);
